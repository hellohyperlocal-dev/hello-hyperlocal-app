...
import { LINDEN_MOCK_FEED, LoveLocalOffer, WhatsOnEvent, CommunityPost, NOTIFICATIONS, StoredUserData } from '@/lib/mock-data';
...
import { getUpvotes, setUpvote } from '@/lib/upvotes';
